...
//////////////////////////////////////////////////////////////////////
// TEMPLATE CLASS PROVIDED: sequence<Item> (a templated container class for a list of items,
//                 where each list may have a designated item called
//                 the current item)
//
// TEMPLATE PARAMETER, TYPEDEFS and MEMBER CONSTANTS for the sequence class:
//   sequence<Item> class
//   The template parameter, Item, is the data type of items in the sequence,
//   also defined as sequence::value_type.
